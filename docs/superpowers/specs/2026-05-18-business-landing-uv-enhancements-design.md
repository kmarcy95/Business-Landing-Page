...
- Hero (composed): `C:\Users\keyst\headshots\linkedin\7ebe20d5-8480-4d66-be5e-52cdc04542e7.png`
- About (smiling): `C:\Users\keyst\headshots\linkedin\87214a06-e06e-41c7-9b28-500308fbe1d2.png`

**Resize script:** `scripts/resize-headshots.ps1` reads the two source paths above directly (no copy step), downsamples to 1024×1024 with bicubic resampling, encodes as progressive JPEG at quality 82, and writes:

- `images/headshot-hero.jpg`
- `images/headshot-about.jpg`

Script is idempotent — running it multiple times produces the same output. Uses PowerShell + `System.Drawing` (already available on Windows 11, no install required). No external dependencies, no Node/Python. The raw `linkedin/` source folder lives outside the repo and is unaffected.
...
- `images/headshot-hero.jpg` — generated by resize script from external source path
- `images/headshot-about.jpg` — generated by resize script from external source path
